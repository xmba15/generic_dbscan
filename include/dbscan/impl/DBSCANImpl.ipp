...
template <int POINT_DIMENSION, typename POINT_TYPE, typename VEC_POINT_TYPE>
DBSCAN<POINT_DIMENSION, POINT_TYPE, VEC_POINT_TYPE>::~DBSCAN() = default;

template <int POINT_DIMENSION, typename POINT_TYPE, typename VEC_POINT_TYPE>
void DBSCAN<POINT_DIMENSION, POINT_TYPE, VEC_POINT_TYPE>::setMinPoints(const int minPoints)
{
    m_minPoints = minPoints;
}

template <int POINT_DIMENSION, typename POINT_TYPE, typename VEC_POINT_TYPE>
void DBSCAN<POINT_DIMENSION, POINT_TYPE, VEC_POINT_TYPE>::setEps(const double eps)
{
    m_eps = eps;
}
